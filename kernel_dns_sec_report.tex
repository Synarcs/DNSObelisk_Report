...
\newcommand{\citeauthoretal}[1]{\citeauthor{#1} \textit{et al.}~\cite{#1}}
...
\Year{2025}
\Program{Department of Computing and Software Systems}

\Chair{Dr. Geetha Thamilarasu}{}{Computing \& Software Systems}
\Signature{Dr. Munehiro Fukuda, Member}
\Signature{Dr. Robert Dimpsey, Member}
...
\begin{algorithm}[H]
\caption{Egress TC-Based DNS Raw SKB Inspection in 
\textbf{Active} Mode}
\label{sec:alg1}
...
\noindent
\textbf{Algorithm~\ref{sec:alg2}} outlines active-mode eBPF map handling in kernel. 
...
\noindent
\textbf{Algorithm~\ref{sec:alg3}} outlines the core logic of the eBPF agent in userspace and intersection with the kernel eBPF programs, maps, deep learning model and agent caching layer.
...
\newpage
\noindent
\textbf{Algorithm~\ref{sec:alg6}} outlines the core logic of eBPF agent in userspace and intersection with kernel eBPF programs, maps, deep learning model, and agent caching layer.
