...
\renewcommand\section{%
  \@startsection {section}{1}{\z@}%
       {-2.5ex \@plus -0.7ex \@minus -0.2ex}% less negative space before
       {1.8ex \@plus 0.2ex}% slightly less space after
       {\def\baselinestretch{1.0}\reset@font\normalsize\bfseries\slshape}%
}
\renewcommand\subsection{%
  \@startsection{subsection}{2}{\z@}%
       {-2.0ex \@plus -0.5ex \@minus -0.1ex}% less negative space before
       {1.2ex \@plus 0.1ex}% less space after
       {\reset@font\normalsize\mdseries\itshape}%
}
\renewcommand\subsubsection{%
  \@startsection{subsubsection}{3}{\z@}%
       {-1.2ex \@plus -0.3ex \@minus -0.1ex}% much less space before, keeps tight but readable
       {0.8ex \@plus 0.1ex}% less space after
       {\reset@font\normalsize\mdseries\itshape}%
}
% part
...
%  Bibliography
%
\def\textofBIB#1{\gdef\@textofBIB{#1}}  
\textofBIB{Bibliography}

\def\thebibliography#1{%
  \chapter*{\@textofBIB\@mkboth{}{}}
  \addcontentsline{toc}{chapter}{\protect\@textofBIB}
  \small % or \footnotesize if you want it even smaller
  \list
  {[\arabic{enumi}]}{%
    ...
    \usecounter{enumi}%
    \itemsep 0.3ex plus 0.1ex minus 0.1ex % Tighter vertical spacing
    \parsep 0pt%
    \partopsep 0pt%
    \topsep 0pt%
  }
  \def\newblock{\hskip .05em plus .33em minus .07em}%
  \sloppy\clubpenalty4000\widowpenalty4000%
  \uwsinglespace % If this makes spacing larger, you can remove or replace with \singlespacing
  \sfcode`\.=1000\relax
}
%
%   Acknowledgments
